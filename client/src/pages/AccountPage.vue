        ...
        <v-card class="mt-3 account-card">
            ...
            <v-card-text>
                <v-form ref="form" v-model="validUser">
                    ...
                    <v-text-field label="Email" variant="underlined" prepend-icon="mdi-email"
        ...
        <v-card class="mt-3 account-card">
            ...
            <v-card-text>
                <v-text-field l abel="Password" prepend-icon="mdi-lock"
                            ...
                            :type="showPassword ? 'text' : 'password'" @click:append="toggleShowPassword"
                            variant="underlined" v-model="pass1" :rules="passwordRules" label="New password"
                            required></v-text-field>
                
                <v-text-field l abel="Password" prepend-icon="mdi-lock"
                            :append-icon="showPassword ? 'mdi-eye' : 'mdi-eye-off'"
                            :type="showPassword ? 'text' : 'password'" @click:append="toggleShowPassword"
                            variant="underlined" v-model="pass2" :rules="passwordRules" label="Repeat new password"
                            required></v-text-field>
            </v-card-text>
